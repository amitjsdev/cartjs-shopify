...
// $(document).on('click','.template-collection .js-qty__adjust--minus',function(){
//   var qtyInput = $(this).parent().find('.js-qty__num');
//   var currVal = qtyInput.val();
//   if(currVal > 1) {
//     currVal = currVal-1;
//   } else {
//     currVal = currVal;
//   }
//   qtyInput.val(currVal);
// })

// $(document).on('click','.template-collection .js-qty__adjust--plus',function(){
//   var qtyInput = $(this).parent().find('.js-qty__num');
//   var currVal = qtyInput.val();
//   currVal = +currVal+1;
//   qtyInput.val(currVal);
...
//custom_code   17-02-2020

$(document).ready(function() {


  //Quantity upadte
  $(document).on('keyup', '#CartContainer1 .quantity,.cartPageQty', function(){
      ...
      if(data.item_count > 0){
        ...
        $.each(data.items, function(key,val) {             
          html +='<tr id="trid_'+ val.id +'" class="responsive-table-row">'+
            ...
            '<button type="button" id="add_'+ val.id +'" class="add cat_qu">+</button></div><a href="#" data-id="'+ val.id +'" class="slide-remove-item" title="Remove Item">Remove</a>'+
